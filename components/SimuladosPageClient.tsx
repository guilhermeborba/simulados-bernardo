...
export default function SimuladosPageClient() {
  ...
  const simulados = [
    ...
    },
    {
      id: 3,
      title: '🌍 Ciências',
      description: 'Explore tópicos sobre seres vivos, corpo humano, o meio ambiente e ecologia com 30 questões desafiadoras',
      emoji: '🔬',
    ...
    },
    {
      id: 5,
      title: '🌏 Geografia',
      description: 'Aprenda sobre mapas, recursos cartográficos, espaços urbanos e rurais com 30 questões interativas',
      emoji: '🗺️',
      color: 'from-red-400 to-red-600',
      href: '/simulado-geografia',
      difficulty: '⭐⭐⭐ 3º Ano',
      questoes: 30,
      pontos: 30,
      comingSoon: false,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <Link href="/" className="text-blue-600 hover:text-blue-800 font-semibold flex items-center gap-2 transition-colors">
            ← Voltar
          </Link>
          <h1 className="text-4xl font-bold text-slate-800">📚 Escolha um Simulado</h1>
          <div className="w-24" />
        </div>

        <Suspense fallback={<div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4 mb-6">Carregando...</div>}>
          <SimuladosDisplay />
        </Suspense>
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8 mb-12">
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-lg text-slate-700 leading-relaxed">
              🎓 Bem-vindo! Aqui você vai encontrar simulados interativos com <strong>gamificação</strong>, <strong> feedback visual</strong> e <strong>dicas pedagógicas</strong> em cada questão.
            </p>
          ...
          {simuladosDisponiveis.map((simulado) => (
            <Link key={simulado.id} href={simulado.comingSoon ? '#' : getFinalHref(simulado)}>
              ...
              >
                ...
                <p className="text-slate-600 mb-6 leading-relaxed">{simulado.description}</p>
                <div
